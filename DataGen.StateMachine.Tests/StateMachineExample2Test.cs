...
using DataGen.StateMachine.Example2;

namespace DataGen.StateMachine.Tests
{
    [TestClass]
    public class StateMachineExample2Test
    {
        ...
        [TestMethod]
        public void StateMachineExample2_HandleStateTransition_StoppedPlay_ReturnsPlaying()
        {
        ...
        [TestMethod]
        public void StateMachineExample2_HandleStateTransition_PlayingStop_ReturnsStopped()
        {
        ...
        public void StateMachineExample2_HandleStateTransition_StoppedPause_ThrowsInvalidStateTransitionException()
        {
        ...
        public void StateMachineExample2_HandleStateTransition_StoppedNull_ThrowsNullTransitionException()
        {
